        ...
        {techStack.map((skill, index) => {
          ...
          return (
            <motion.div
              ...
              className=" group p-4 flex flex-col items-center  rounded-xl border border-blue-500/30 group bg-black/[0.03] hover:bg-black/[0.06] dark:bg-gray-900/30 dark:hover:bg-gray-800/50 transition-all duration-500"
            >
              ...
              <span className="text-sm font-medium text-gray-700 group-hover:text-gray-900 dark:text-gray-300 dark:group-hover:text-white transition-colors duration-300">
                {skill.name}
              </span>
            </motion.div>
          );
